#!/usr/bin/env python
"""
Test script for the element relationship functionality in the natal chart API without birth time.
This script sends a request to the API with test birth data (no time) and prints the element relationship results.
"""
...
def test_element_relationships_no_time():
    """
    Test the element relationship functionality by sending a request to the natal chart API
    without birth time and printing the element relationship results.
    """
    # API endpoint
    ...
    data = {
        "name": "Element Relationship Test User (No Time)",
    ...
    try:
        ...
        if response.status_code == 200:
            ...
            with open("element_relationships_no_time_response.json", "w") as f:
                json.dump(result, f, indent=2)
                
            print("\n=== Element Relationship Test Results (No Time) ===")
...
if __name__ == "__main__":
    test_element_relationships_no_time() 